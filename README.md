...
`julia -m pytest circular_buffer_test.py`
...
Note that, when trying to submit an exercise, make sure the solution is in the `$EXERCISM_WORKSPACE/julia/circular-buffer` directory.
